...
void task1EntryFunction(void const * argument);
void task2EntryFunction(void const * argument);
...
/* USER CODE BEGIN Header_task1EntryFunction */
/**
  * @brief  Function implementing the task1 thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_task1EntryFunction */
void task1EntryFunction(void const * argument)
{
...
/* USER CODE BEGIN Header_task2EntryFunction */
/**
* @brief Function implementing the task2 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_task2EntryFunction */
void task2EntryFunction(void const * argument)
{
  /* USER CODE BEGIN task2EntryFunction */
  /* Infinite loop */
  for(;;)
  {
